...
public class MenuLogin extends AbstractFrameDefault {
	...
	private static final String DATABASE_DEFAULT = "WineryDesktopApp.accdb";
	...
	public static void main(final String[] arg) {
		try {	
			...
			try {
				...
				while (!dataBase.getName().equals(DATABASE_DEFAULT)) {
					Components.errorPane("Selezionare database '" + DATABASE_DEFAULT + "' ", f);
					dataBase = Utility.dbChoosen(f);
				}			
				f.display();
