...
-- * LUN file: C:\Users\maric\OneDrive\Basi\Progetto\Basi_WorkSpace\progettobasi\Relazione\Azienda_Agricola.lun
...
create table [Dettagli_Acquisto] (
     ...
     [Prezzo_Totale_Bottilglia] single,
     [Numero_Litri] single,
...
--Not implemented
--alter table [Acquisto] add constraint [ID_Acquisto_CHK]
--     check(exists(select * from [Dettagli_Acquisto]
--                  where [Dettagli_Acquisto].[ID_Acquisto] = [ID_Acquisto]));
...
--Not implemented
--alter table [Persona_Azienda] add constraint [ID_Persona_Azienda_CHK]
--     check(exists(select * from [Gruppo_Pigiatura]
--                  where [Gruppo_Pigiatura].[ID_Operaio] = [ID]));

--Not implemented
--alter table [Persona_Azienda] add constraint [ID_Persona_Azienda_CHK]
--     check(exists(select * from [Gruppo_Raccolta]
--                  where [Gruppo_Raccolta].[ID_Operaio] = [ID]));

--Not implemented
--alter table [Persona_Azienda] add constraint [ID_Persona_Azienda_CHK]
--     check(exists(select * from [Gruppo_Sfecciatura]
--                  where [Gruppo_Sfecciatura].[ID_Operaio] = [ID]));

--Not implemented
--alter table [Persona_Azienda] add constraint [ID_Persona_Azienda_CHK]
--     check(exists(select * from [Gruppo_Svinatura]
--                  where [Gruppo_Svinatura].[ID_Operaio] = [ID]));

--Not implemented
--alter table [Persona_Azienda] add constraint [ID_Persona_Azienda_CHK]
--     check(exists(select * from [Assunzione]
--                  where [Assunzione].[ID_Operaio] = [ID]));

--Not implemented
--alter table [Persona_Azienda] add constraint [ID_Persona_Azienda_CHK]
--     check(exists(select * from [Assunzione]
--                  where [Assunzione].[ID_Proprietario] = [ID]));

--Not implemented
--alter table [Persona_Azienda] add constraint [ID_Persona_Azienda_CHK]
--     check(exists(select * from [Login]
--                  where [Login].[ID_Aziendale] = [ID]));

--Not implemented
--alter table [Pigiatura] add constraint [ID_Pigiatura_CHK]
--     check(exists(select * from [Gruppo_Pigiatura]
--                  where [Gruppo_Pigiatura].[ID_Pigiatura] = [ID_Fase]));

--Not implemented
--alter table [Pigiatura] add constraint [ID_Pigiatura_CHK]
--     check(exists(select * from [Mosto]
--                  where [Mosto].[ID_Pigiatura] = [ID_Fase]));

--Not implemented
--alter table [Pigiatura] add constraint [ID_Pigiatura_CHK]
--     check(exists(select * from [Raspi]
--                  where [Raspi].[ID_Pigiatura] = [ID_Fase]));
...
--Not implemented
--alter table [Raccolta] add constraint [ID_Raccolta_CHK]
--     check(exists(select * from [Gruppo_Raccolta]
--                  where [Gruppo_Raccolta].[ID_Raccolta] = [ID_Fase]));
...
--Not implemented
--alter table [Sfecciatura] add constraint [ID_Sfecciatura_CHK]
--     check(exists(select * from [Gruppo_Sfecciatura]
--                  where [Gruppo_Sfecciatura].[ID_Sfecciatura] = [ID_Fase]));

--Not implemented
--alter table [Sfecciatura] add constraint [ID_Sfecciatura_CHK]
--     check(exists(select * from [Feccia]
--                  where [Feccia].[ID_Sfecciatura] = [ID_Fase]));

--Not implemented
--alter table [Sfecciatura] add constraint [ID_Sfecciatura_CHK]
--     check(exists(select * from [Vino]
--                  where [Vino].[ID_Sfecciatura] = [ID_Fase]));
...
--Not implemented
--alter table [Svinatura] add constraint [ID_Svinatura_CHK]
--     check(exists(select * from [Gruppo_Svinatura]
--                  where [Gruppo_Svinatura].[ID_Svinatura] = [ID_Fase]));

--Not implemented
--alter table [Svinatura] add constraint [ID_Svinatura_CHK]
--     check(exists(select * from [Vinaccia]
--                  where [Vinaccia].[ID_Svinatura] = [ID_Fase]));

--Not implemented
--alter table [Svinatura] add constraint [ID_Svinatura_CHK]
--     check(exists(select * from [VNF]
--                  where [VNF].[ID_Svinatura] = [ID_Fase]));
...
--Not implemented
--alter table [Uva] add constraint [ID_Uva_CHK]
--     check(exists(select * from [Pigiatura]
--                  where [Pigiatura].[Uva] = [Nome_Uva]));

--Not implemented
--alter table [Uva] add constraint [ID_Uva_CHK]
--     check(exists(select * from [Raccolta]
--                  where [Raccolta].[Uva] = [Nome_Uva]));

--Not implemented
--alter table [Uva] add constraint [ID_Uva_CHK]
--     check(exists(select * from [Sfecciatura]
--                  where [Sfecciatura].[Uva] = [Nome_Uva]));

--Not implemented
--alter table [Uva] add constraint [ID_Uva_CHK]
--     check(exists(select * from [Svinatura]
--                  where [Svinatura].[Uva] = [Nome_Uva]));

--Not implemented
--alter table [Vendemmiatrice] add constraint [ID_Vendemmiatrice_CHK]
--     check(exists(select * from [Gruppo_Raccolta]
--                  where [Gruppo_Raccolta].[ID_Vend] = [ID_Vend]));
...
--Not implemented
--alter table [Vino] add constraint [FKPro_Vin_CHK]
--     check(exists(select * from [Dettagli_Acquisto]
--                  where [Dettagli_Acquisto].[ID_Vino] = [ID_Sfecciatura]));
