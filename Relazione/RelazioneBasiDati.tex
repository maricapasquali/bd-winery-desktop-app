...
\end{figure}\\
Il pulsante "Avanti" verifica che la fase selezionata sia inserita, nel qual caso vengono inserite, nella ComboBox, le date della fase in cui non sono stati inseriti gli opeari che l'hanno svolta (figura successiva).
\begin{figure}[htbp]
\centering
...
\begin{tabular}{lp{0.5\textwidth} lp{0.5\textwidth} }\hline
